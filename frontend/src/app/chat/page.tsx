  ...
  const handleSendMessage = (content: string) => {
    ...
    setTimeout(() => {
      const aiResponse: Message = {
        ...
        role: 'assistant',
        content: `Thank you for sharing. I've analyzed your prompt regarding "${content}". Please remember to consult a certified doctor for formal diagnostic procedures.`,
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
      };
